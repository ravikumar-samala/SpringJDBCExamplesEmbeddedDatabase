...
public class SpringJDBCExamplesApp {
   ...
   "applicationContext_DB.xml");
	...
	private void run() {
		...
		logger.info("Everything about everybody (check for Jeff Day) is " + personService.getPeople());
		...
		logger.info("Everything about everybody (check for that Jeff Day is now Jeff Mowen) is " + personService.getPeople());
		
		personService.deletePerson(person);
		
		logger.info("Everything about everybody (check for that Jeff Mowen is now GONE) is " + personService.getPeople());
		...
		/*create a Person object and just set it last name field*/
		...
		logger.info("Everything about everybody (check for Todd Kofford) is " + personService.getPeople());
